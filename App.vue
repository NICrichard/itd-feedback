  ...
  <div id="app" class="container">
    ...
    <div class="row text-center">
      ...
      <div class="row">
        <div class="col-md-4">
          <i
            :class="{'flaticon-smiley':true, 'selected':(isActive === 1)}"
            @click="clicked('happy')"
          ></i>
        </div>
        <div class="col-md-4">
          <i :class="{'flaticon-anger':true, 'selected':(isActive === 2)}" @click="clicked('meh')"></i>
        </div>
        <div class="col-md-4">
          <i
            :class="{'flaticon-sad-smiley':true, 'selected':(isActive === 3)}"
            @click="clicked('sad')"
          ></i>
        </div>
      </div>
